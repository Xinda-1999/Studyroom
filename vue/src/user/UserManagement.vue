<template>
  <div>
    ...
    <el-form>
      ...
      <!-- 用户输入 -->
      <el-form-item label="个人信息" label-width="600px" style="font-weight: bold; font-size: 16px;"></el-form-item>
      <el-form-item label="学工号" label-width="450px">
        ...
        <el-form-item label="用户名" label-width="450px">
      ...
      <!-- 退出按钮 -->
      <el-form-item label=" " label-width="450px">
        <!-- 按了修改后会调用exit函数 -->
        <el-button type="primary" @click="handle(url)"  style="width: 150px;">预约记录</el-button>
...
export default {
  ...
  methods: {
    ...
    // 查询历史记录
    handle(url) {
      window.location.href = "http://localhost:8080/student/history"
    },
